      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {highlights.map((h) => (
            ...
            >
              <div className="flex size-12 items-center justify-center rounded-xl bg-ocean/10 text-ocean transition-colors group-hover:bg-primary group-hover:text-primary-foreground">
