  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <a href="#top" className="shrink-0" aria-label="Bali Taoka Villa — home">
          <Logo />
        </a>
      ...
      <div
        ...
        aria-hidden
        className={cn(
          "fixed inset-0 top-16 z-40 bg-charcoal/40 backdrop-blur-sm transition-opacity duration-300 lg:hidden",
